...
class _UserListScreenState extends State<UserListScreen> {
  ...
  Future<void> _refreshUsers() async {
    setState(() {
      _usersFuture = UserDatabaseHelper.instance.getAllUsers(); //Lấy toàn bộ danh sách người dùng
    });
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: FutureBuilder<List<User>>( //chờ đợi danh sách User đang load về
        future: _usersFuture,
        builder: (context, snapshot) {
          if (snapshot.connectionState == ConnectionState.waiting) {
            ...
            return ListView.builder( //Layout bố trí data theo dạng list
